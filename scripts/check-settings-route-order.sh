...
#
# CI gate: fails if any specific literal GET/POST/PUT/PATCH/DELETE route is declared
...
#
# What is flagged:
#   For each HTTP verb (get, post, put, patch, delete) in each .ts file under
...
echo "╠══════════════════════════════════════════════════════════════════════╣"
echo "║  Un handler router.post/put/patch/delete(\"/percorso-specifico\", …) ║"
