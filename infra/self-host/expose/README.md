...
Lo stack self-host avvia GraphHopper, Valhalla, Ollama e Photon
...
5. **Rate-limit** — header di rate-limiting presenti su Ollama e Photon
...
obsolete service tokens (override del `.env.local),
