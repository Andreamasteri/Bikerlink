...
- **REGOLA FISSA — Split di file VIETATO senza autorizzazione**: Prima di splittare qualsiasi file (indipendentemente dalla dimensione o dal motivo), l'agente DEVE chiedere esplicita autorizzazione all'utente e attendere il via libera. Nessuna eccezione, nemmeno per il ratchet 600-line.
