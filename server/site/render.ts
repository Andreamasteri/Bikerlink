  ...
  <div class="footer-inner">
    <div>
      ...
      <div style="margin-top:14px">
        <a href="https://www.youtube.com/@Bikerlink-f4k" target="_blank" rel="noopener" aria-label="Canale YouTube BikerLink" style="display:inline-flex;align-items:center;gap:8px;color:var(--text3);font-size:12px;font-weight:600;letter-spacing:1px;text-decoration:none;transition:color .2s" onmouseover="this.style.color='#FF0000'" onmouseout="this.style.color='var(--text3)'">
