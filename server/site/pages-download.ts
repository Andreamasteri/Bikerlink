  ...
  <div class="section-inner">
    ...
    <div class="grid grid-3">
      ...
      <article class="card">
        ...
        <div style="margin-top:16px"><a class="btn btn-outline disabled" href="#">Prossimamente</a></div>
        <div class="meta">App Store</div>
      </article>
    </div>
  </div>
</section>
...
<section class="section alt">
  <div class="section-inner">
    <span class="section-eyebrow">Sviluppatori & Beta</span>
    <h2 class="section-title">Prova con <span class="accent">Expo Go</span></h2>
    <div class="grid grid-2">
      <div class="prose">
        <p>BikerLink è costruita con Expo. Se sei uno sviluppatore o vuoi provare le ultimissime build prima del rilascio ufficiale, puoi caricarle direttamente tramite l'app Expo Go.</p>
        <ul>
          <li>Installa <strong>Expo Go</strong> dal Play Store o App Store.</li>
          <li>Inquadra il QR code a lato (o sotto su mobile).</li>
          <li>L'app si caricherà istantaneamente sul tuo dispositivo.</li>
        </ul>
        <p style="margin-top:16px"><a class="btn btn-outline" href="https://expo.dev/client" target="_blank" rel="noopener">Cos'è Expo Go?</a></p>
      </div>
...
<section class="section">
  <div class="section-inner prose">
    ...
    <p>La sicurezza dei tuoi dati e del tuo dispositivo è la nostra priorità. Tutte le versioni di BikerLink — che provengano dal Play Store o dall'APK diretto — sono firmate crittograficamente con lo stesso certificato di rilascio. Questo garantisce che l'app non sia stata manomessa e permette di passare da un canale all'altro senza perdere i dati (basta installare sopra la versione esistente).</p>
    <p>Non scaricare BikerLink da siti di terze parti non autorizzati. Gli unici canali sicuri sono quelli elencati in questa pagina.</p>
    <p>Per maggiori informazioni su come gestiamo i tuoi dati, consulta la <a href="/privacy">Privacy Policy</a>. Se hai problemi con l'installazione, scrivi al supporto tramite la pagina <a href="/contact">contatti</a>.</p>
  </div>
</section>

<section class="cta-block">
  <h2>Tutto pronto?</h2>
  <p>Scarica BikerLink, crea il tuo profilo e connettiti con la community.</p>
  <div class="btn-row"><a class="btn btn-primary" href="/download">Vai al Google Play</a></div>
</section>
`;
  return { meta, body };
}
