...
// Spostati in ./inter-agent-tools.ts (girano su modelli pesanti self-hosted senza
// il tetto di 8s di guardTool). Ri-esportati qui per compatibilità dei chiamatori.
export {
