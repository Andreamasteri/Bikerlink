...
// 9 nuovi check (totale stack: orphans 11 + extra 9 = 20 in pacchetto orfani)
const checks: IntegrityCheck[] = [
  ...
  { id: "orphans-x/sos-alerts-user",      name: "sos_alerts senza utente",                  category: "orphans", severity: "high",   cost: "cheap",  description: "SOS attivati da utenti non più presenti.",         query: () => orphanCheck("sos_alerts", "user_id", "users") },
  { id: "orphans-x/sessions-user",        name: "user_sessions senza utente",               category: "orphans", severity: "high",   cost: "cheap",  description: "Sessioni residue dopo cancellazione utente.",      query: () => orphanCheck("user_sessions", "user_id", "users") },
  { id: "orphans-x/push-tokens-user",     name: "user_push_tokens senza utente",            category: "orphans", severity: "medium", cost: "cheap",  description: "Push token residui.",                              query: () => orphanCheck("user_push_tokens", "user_id", "users") },
  ...
  { id: "orphans-x/chat-messages-conv",   name: "chat_messages senza conversazione",        category: "orphans", severity: "high",   cost: "medium", description: "Messaggi orfani dopo cancellazione conversazione.", query: () => orphanCheck("chat_messages", "conversation_id", "chat_conversations") },
];
