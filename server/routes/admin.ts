...
import { motoClubs, motoClubRequests, motoClubMembers, motoClubInvites, zavarrinaWishlists, zavarrinaWishlistMotos, conversations, conversationParticipants, messages, feedbackTickets, moderatorLogs, users, userProfiles, userMotorcycles, bikerZavarrinaMatches, bikerBikerMatches, serverRestarts, appSettings, userMusicTracks, userLastfmSessions, userPlaylistSnapshots, otaEvents, adCampaigns as adCampaignsTable, matchPreferences, gpsRejectionStats, siteVisits, rideTelemetry, routes, otaPublishTokens } from "@shared/db";
import { otaErrorSchema, createAdCampaignSchema, createInviteCodeSchema, upsertSettingSchema, emailConfigSchema, disableFeatureSchema, toggleProtectedSchema, publishWithSlotSchema, createOtaTokenSchema, assignOtaSlotSchema, publishOtaReleaseSchema, booleanSettingValueSchema, stringSettingValueSchema, mapsProviderSchema, clientErrorSchema, startupBeaconSchema, verifyPasswordSchema, userStatusSchema, userRoleSchema, userEmailAdminSchema, adminSetPasswordSchema, primalSchema, workshopSchema, easterEggSchema, easterEggBatchSchema, reportResolveSchema, emailTestSchema, emailRateLimitResetSchema, themeDefaultSchema, matchingCountriesSchema, coordinatesMaxAgeSchema, genericSettingSchema, adsBulkSchema, adsCreateSchema, adsUpdateSchema, adsBulkDeleteSchema, adsGroupUpdateSchema, stregattaSchema, stregattaToggleSchema, rejectNoteSchema, simulateActivitySchema, updateInvitationCodeAdminSchema, enabledSchema, backupFrequencySchema, reconcileClubInvitesSchema, translationKeySchema, coordinateHistorySettingsSchema, bgLocationSettingsSchema, privacyRulesSchema, nativeVersionSchema, otaAssignDeviceSchema, otaPromoteSchema, otaMarkBrokenSchema, urlSettingSchema, maintenanceSettingsSchema, curvyScoreWeightsSchema, telemetryTargetKmSchema } from "@shared/validators";
