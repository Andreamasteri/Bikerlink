 ...
 *
 * Backed by the canonical REDIS_URL provider (Upstash/VPS Redis, Redis-protocol
 * compatible). TC_DRAGONFLY_URL is supported only as a legacy fallback. Lazily instantiated —
