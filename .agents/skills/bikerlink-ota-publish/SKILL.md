...
- Ciclo 7.x: OTA 44–55+ (APK versionCode 13→28, rv 7.0.0) ← CORRENTE
  ...
  - APK v29: STABILE — expo-notifications nativo + versionCode 29 + versionName 1.9.4 (EAS: 2680c671, APK: https://expo.dev/artifacts/eas/5KLcwsgh9jtqLLdNrbxNxg.apk) + OTA 63–64–65–
