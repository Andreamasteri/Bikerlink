...
|---|---|---|
| `app.json` | `expo.version` | `51.1.10` |
| `app.json` | `expo.android.versionCode` | `51` |
| `app.json` | `expo.runtimeVersion` | `10.0.0` |
| `android/app/build.gradle` | `versionCode` | `51` |
| `android/app/build.gradle` | `versionName` | `"51.1.10"` |
...
| v51 | 51 | 51.1.10 | 10.0.0 | 10.x | — | **Corrente** — OTA-1 inglobata, fix mappa/offline/RoadHazards/profilo |
