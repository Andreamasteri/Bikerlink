...
| Stato | Servizi |
|---|---|
| ✅ Operativi e validati | Database, Sessioni, OpenAI, Gemini, GraphHopper (cloud), Gmail, Last.fm |
| ⚠️ Configurati con problemi | Ollama (403), GraphHopper self-hosted (DNS), Tiles (DNS) |
