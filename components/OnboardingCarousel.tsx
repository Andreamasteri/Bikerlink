...
export const ONBOARDING_SLIDES: OnboardingSlide[] = [
  {
    id: "01",
    image: require("@/assets/images/onboarding/01-posizione-fake-intro.png"),
  ...
  {
    id: "02",
    image: require("@/assets/images/onboarding/02-posizione-fake-attivazione.png"),
    section: "Posizione Fake",
  ...
  {
    id: "03",
    image: require("@/assets/images/onboarding/03-posizione-fake-quando.png"),
    section: "Posizione Fake",
    title: "Quando usarla",
  ...
  {
    id: "04",
    image: require("@/assets/images/onboarding/04-posizione-fake-privacy.png"),
    section: "Posizione Fake",
  ...
  {
    id: "05",
    image: require("@/assets/images/onboarding/05-garage-intro.png"),
    section: "Garage",
  ...
  {
    id: "06",
    image: require("@/assets/images/onboarding/06-garage-inserisci-moto.png"),
    section: "Garage",
  ...
  {
    id: "07",
    image: require("@/assets/images/onboarding/07-wishlist-intro.png"),
    section: "Garage",
    title: "Wishlist moto",
  ...
  {
    id: "08",
    image: require("@/assets/images/onboarding/08-wishlist-aggiungi.png"),
    section: "Garage",
  ...
  {
    id: "09",
    image: require("@/assets/images/onboarding/09-registra-giro-intro.png"),
  ...
  {
    id: "10",
    image: require("@/assets/images/onboarding/10-registra-giro-avvio.png"),
    section: "Registra Giro",
  ...
  {
    id: "11",
    image: require("@/assets/images/onboarding/11-registra-giro-dati.png"),
    section: "Registra Giro",
  ...
  {
    id: "12",
    image: require("@/assets/images/onboarding/12-registra-giro-condividi.png"),
    section: "Registra Giro",
  ...
  {
    id: "13",
    image: require("@/assets/images/onboarding/13-matching-biker-intro.png"),
  ...
  {
    id: "14",
    image: require("@/assets/images/onboarding/14-matching-biker-dati.png"),
    section: "Matching Biker",
  ...
  {
    id: "15",
    image: require("@/assets/images/onboarding/15-matching-biker-risultato.png"),
    section: "Matching Biker",
  ...
  {
    id: "16",
    image: require("@/assets/images/onboarding/16-matching-biker-profilo.png"),
    section: "Matching Biker",
  ...
  {
    id: "17",
    image: require("@/assets/images/onboarding/17-matching-musicale-intro.png"),
  ...
  {
    id: "18",
    image: require("@/assets/images/onboarding/18-lastfm-registrazione.png"),
    section: "Matching Musicale",
  ...
  {
    id: "19",
    image: require("@/assets/images/onboarding/19-lastfm-collegamento.png"),
    section: "Matching Musicale",
  ...
  {
    id: "20",
    image: require("@/assets/images/onboarding/20-matching-musicale-sblocca.png"),
    section: "Matching Musicale",
  ...
  {
    id: "21",
    image: require("@/assets/images/onboarding/21-mappa-live.png"),
    section: "Mappa Live",
  ...
  {
    id: "22",
    image: require("@/assets/images/onboarding/22-motoclub-intro.png"),
    section: "MotoClub",
  ...
  {
    id: "23",
    image: require("@/assets/images/onboarding/23-motoclub-unisciti.png"),
    section: "MotoClub",
  ...
  {
    id: "24",
    image: require("@/assets/images/onboarding/24-sos-emergenza.png"),
  ...
  {
    id: "25",
    image: require("@/assets/images/onboarding/25-chat-biker.png"),
    section: "Chat",
  ...
  {
    id: "26",
    image: require("@/assets/images/onboarding/26-profilo-biker.png"),
    section: "Profilo",
  ...
  {
    id: "27",
    image: require("@/assets/images/onboarding/27-notifiche-push.png"),
    section: "Notifiche",
  ...
  {
    id: "28",
    image: require("@/assets/images/onboarding/28-hashtag-chat.png"),
    section: "Chat",
  ...
  {
    id: "29",
    image: require("@/assets/images/onboarding/29-codici-invito.png"),
    section: "Inviti",
    title: "Codici invito",
  ...
  {
    id: "30",
    image: require("@/assets/images/onboarding/30-bikerlink-benvenuto.png"),
    section: "Benvenuto",
