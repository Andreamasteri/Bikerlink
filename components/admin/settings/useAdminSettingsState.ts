...
export function useAdminSettingsState({ isAdmin, t, setTheme }: UseAdminSettingsStateProps) {
  ...
  return {
    ...
    otaGateEnabled: maintenance.otaGateEnabled,
    otaGateMutation: maintenance.otaGateMutation,
    otaWaitInput: maintenance.otaWaitInput,
    setOtaWaitInput: maintenance.setOtaWaitInput,
    otaWaitMutation: maintenance.otaWaitMutation,
    otaWaitPending: maintenance.otaWaitPending,
    ...
    handleSave,
    updateMutation,
    otaRetentionInput: maintenance.otaRetentionInput,
    setOtaRetentionInput: maintenance.setOtaRetentionInput,
    otaRetentionMutation: maintenance.otaRetentionMutation,
