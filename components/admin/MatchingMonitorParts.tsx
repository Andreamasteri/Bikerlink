...
const styles = StyleSheet.create({
  ...
  errorCountNote: { fontFamily: "Inter_500Medium", fontSize: 11, color: "#ef4444", marginBottom: 4 },
  ...
  errorIdLink: { fontFamily: "Inter_400Regular", fontSize: 10, color: "#f97316", textDecorationLine: "underline" },
  volatileNote: { fontFamily: "Inter_400Regular", fontSize: 10, color: Colors.textSecondary, marginTop: 6, textAlign: "center" },
